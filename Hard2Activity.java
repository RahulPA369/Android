...
public class Hard2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1 = (TextView)findViewById(R.id.h2txt1);
        t2 = (TextView)findViewById(R.id.h2txt3);
        t3 = (TextView)findViewById(R.id.h2txt4);
        b1 = (Button)findViewById(R.id.h2btn1);
        b2 = (Button)findViewById(R.id.h2btn2);
