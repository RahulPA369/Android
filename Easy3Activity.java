...
public class Easy3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1 = (TextView)findViewById(R.id.e3txt1);
        t2 = (TextView)findViewById(R.id.e3txt3);
        t3 = (TextView)findViewById(R.id.e3txt4);
        b1 = (Button)findViewById(R.id.e3btn1);
        b2 = (Button)findViewById(R.id.e3btn2);
